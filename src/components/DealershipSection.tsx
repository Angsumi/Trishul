...
export const DealershipSection: React.FC<DealershipSectionProps> = ({ onApplyDealership }) => {
  ...
  return (
    <section id="dealership" className="py-24 bg-slate-900 border-t border-slate-800 relative overflow-hidden">
      ...
      <div className="absolute bottom-10 right-10 w-[400px] h-[400px] bg-blue-600/10 rounded-full blur-[130px] pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white tracking-tight">
            Become an Authorized <span className="gradient-text-solar">EV Dealer / Channel Partner</span>
          </h2>
        ...
        <div className="mb-14 p-6 sm:p-8 rounded-3xl bg-gradient-to-r from-slate-950 via-slate-900 to-amber-950/60 border border-amber-500/30 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        {/* Call to Discussion */}
        <div className="mt-14 p-8 rounded-3xl bg-slate-950 border border-slate-800 text-center space-y-4 max-w-2xl mx-auto shadow-2xl">
          ...
          <div className="pt-2">
            <button
              onClick={onApplyDealership}
              className="inline-flex items-center space-x-2 px-8 py-3.5 rounded-xl text-xs font-extrabold bg-gradient-to-r from-emerald-600 to-green-600 hover:from-emerald-500 hover:to-green-500 text-white shadow-xl shadow-emerald-950/80 transition-all"
            >
