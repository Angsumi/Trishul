...
import { Sun, CheckCircle2, ArrowRight, ShieldCheck, Zap, Award, Sparkles, TrendingUp, ChevronRight } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            {/* Top Scheme Badge */}
            <div className="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-slate-900/90 border border-emerald-500/30 text-xs font-semibold text-emerald-400 shadow-md">
              <span className="flex h-2 w-2 rounded-full bg-emerald-400 animate-ping"></span>
              <span className="font-bold text-amber-400">PM SURYA GHAR</span>
              <span className="text-slate-500">•</span>
              <span>Central & State Subsidy Scheme in Assam</span>
            </div>

            {/* Main Headline */}
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-white leading-[1.1]">
              PM SURYA GHAR <br />
              <span className="gradient-text-emerald">MUFT BIJLI YOJANA</span>
            </h1>
            ...
            <div className="p-4 rounded-2xl bg-gradient-to-r from-emerald-950/80 via-slate-900 to-amber-950/40 border border-emerald-500/40 shadow-xl relative overflow-hidden group">
              <div className="absolute -right-6 -bottom-6 w-24 h-24 bg-amber-500/10 rounded-full blur-xl group-hover:scale-125 transition-transform"></div>
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 relative z-10">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <span className="text-xs uppercase tracking-wider text-slate-400 font-bold">Government Subsidy</span>
                ...
                <div className="self-start sm:self-center">
                  <span className="inline-flex items-center text-xs font-semibold px-3 py-1.5 rounded-lg bg-emerald-500/20 text-emerald-300 border border-emerald-500/40">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
              {[
                ...
                <div key={idx} className="flex items-start space-x-2.5 bg-slate-900/60 p-2.5 rounded-xl border border-slate-800/80">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-4">
              <button
                ...
                className="px-6 py-3.5 rounded-xl text-sm font-bold bg-gradient-to-r from-emerald-600 via-emerald-500 to-green-600 hover:from-emerald-500 hover:to-green-500 text-white shadow-xl shadow-emerald-950/60 hover:shadow-emerald-900/50 transition-all flex items-center justify-center space-x-2 group"
              >
            ...
            <p className="text-xs text-slate-400 pt-1 flex items-center space-x-2">
              ...
              <span>Trishul Innovations — End-to-end solar & EV solutions across Guwahati & Assam.</span>
            </p>

          </div>

          {/* Right Column: Clean Interactive Feature Highlights Card */}
          <div className="lg:col-span-5 relative">
            <div className="relative mx-auto max-w-md lg:max-w-none rounded-3xl border border-slate-800 bg-slate-900/90 shadow-2xl p-6 sm:p-8 space-y-6">
              ...
              <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-white">Clean Energy Highlights</h3>
              ...
              <div className="pt-2 text-center">
                <button
                  ...
                  className="w-full py-3 rounded-xl text-xs font-bold bg-slate-950 hover:bg-slate-800 text-emerald-400 border border-emerald-500/30 transition-all flex items-center justify-center space-x-2"
                >
            ...
            {/* Ambient Backlight */}
            <div className="absolute -z-10 -bottom-6 -right-6 w-64 h-64 bg-emerald-500/15 rounded-full blur-3xl"></div>
          </div>
